...
<div class="panel panel-default">
    <div class="panel-body">         
        <!--Crear nuevo rol-->
        <div class="col-lg-8">
             {!! Form::open(['route' => 'roptrimestre/create_telefono', 'class' => 'form','autocomplete'=>'off']) !!}
             <input type="hidden" id="id_index_testing" name="id_index_testing" value="{{ $obj_filtro }}">
                <table class="table table-condensed">
                    ...
                    <tr>
                      ...
                      <td><input type="text" maxlength="30" class="form-control" name="numero_telefono" id="numero_telefono" placeholder="numero_telefono" required autofocus></td>
                    </tr>
                    <tr>
                      <td>Enviar SMS</td>
                      <td><input type="checkbox" class="custom-control-input" name="enviar_sms" id="enviar_sms" value="1"></td>
                    </tr>
                    <tr>
                      <td>Telefono Principal</td>
                      <td><input type="checkbox" class="custom-control-input" name="principal" id="principal" value="1"></td>
                    </tr>
