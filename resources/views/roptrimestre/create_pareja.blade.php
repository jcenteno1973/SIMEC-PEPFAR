...
<div class="panel panel-default">
    <div class="panel-body">         
        <!--Crear nuevo rol-->
        <div class="col-lg-8">
             {!! Form::open(['route' => 'roptrimestre/create_pareja', 'class' => 'form','autocomplete'=>'off']) !!}
             <input type="hidden" id="ind_id_index_testing" name="ind_id_index_testing" value="{{ $obj_filtro }}">
                <table class="table table-condensed">
                    <tr>
                      <td>Nombres</td>
                      <td><input type="text" maxlength="30" class="form-control" name="nombres" placeholder="nombres" ></td>
                    </tr>
                    <tr>
                      <td>Apellidos</td>
                      <td><input type="text" maxlength="30" class="form-control" name="apellidos" placeholder="apellidos" ></td>
                    </tr>
                    <tr>
                      <td>Tipo Pareja</td>
                      <td>
                    ...
                    <tr>
                      <td>edad</td>
                      <td><input type="number" min="0" max="120" class="form-control" name="edad" id="edad" ></td>
                    </tr>
                    <tr>
                      <td>sexo</td>
                      <td>
