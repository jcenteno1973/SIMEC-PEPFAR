...
<div class="panel panel-default">
    <div class="panel-body">         
        <!--Crear nuevo rol-->
        <div class="col-lg-8">
             {!! Form::open(['route' => 'roptrimestre/create_datos', 'class' => 'form','autocomplete'=>'off']) !!}
                ...
                <table class="table table-condensed">
                    ...
                    <tr>
                      <td>Cantidad</td>
                      <td>
                        <input type="radio" name="col_numdeno" value="numerador" checked> Numerador<br>
                        <input type="radio" name="col_numdeno" value="denominador"> Denominador<br>
                        <input type="text" maxlength="6" class="form-control" name="col_numdeno_val" id="col_numdeno_val" placeholder="Solo Numeros Enteros" pattern="^[1-9]\d*$" required >
                      </td>
                    </tr>
                    @endif
