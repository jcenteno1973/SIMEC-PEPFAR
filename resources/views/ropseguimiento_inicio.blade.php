...
<div class="list-group">
    <a href="roptrimestre/index_indextesting" class="list-group-item">NAP / C</a>
    <a href="roptrimestre/index_datos/30" class="list-group-item">Cascada</a>
</div>
@stop
@section('contenido')
<div class="panel panel-default">
    ...
    <center>
        ...
        Usted se encuentra en el m&oacute;dulo ROP Seguimiento.<br>
