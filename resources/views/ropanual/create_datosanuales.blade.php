...
<div class="panel panel-default">
    <div class="panel-body">         
        <!--Crear nuevo rol-->
        <div class="col-lg-8">
             {!! Form::open(['route' => 'ropanual/create_datosanuales', 'class' => 'form','autocomplete'=>'off']) !!}
                ...
                <table class="table table-condensed">
                    ...
                    <tr>	
                      ...
                      <td>	
                        <select name="id_periodo_anual" placeholder="id_periodo_anual" class="form-control" required>	
                            ...
                            @if (Input::old('id_periodo_anual')==$obj_item->id_periodo_anual)	
                    ...
                    <tr>	
                      ...
                      <td>	
                        <select name="id_semana" placeholder="id_semana" class="form-control" required>	
                            ...
                            @if (Input::old('id_semana')==$obj_item->id_semana)	
                    ...
                    <tr>
                      ...
                      <td>
                        <select name="col_sitesting" id="col_sitesting" placeholder="col_sitesting" class="form-control" required>
                            <option value="" >-- Seleccionar -- </option>
                            <option value="2">Ofrecen</option>
                            <option value="3">Aceptan</option>
                        </select>
                      </td>
                    </tr>
                    @endif
                    ...
                    <tr>
                      ...
                      <td><input type="text" maxlength="6" class="form-control" name="cant_personas" id="cant_personas" placeholder="Solo Numeros Enteros" pattern="^[1-9]\d*$" step="0.01" required ></td>
                    </tr>
                    @endif
                    @if(in_array('gasto',$obj_param->def_columns['name_col']))
                    <tr>
                      <td>Gasto Total</td>
                      <td><input type="text" maxlength="12" class="form-control" name="gasto" id="gasto" placeholder="Solo Numeros, 2 decimales maximo" pattern="^[0-9]+\.?[0-9]*$" required ></td>
                    </tr>
                    @endif
                    @if(in_array('cant_servi_prueba',$obj_param->def_columns['name_col']))
                    <tr>
                      <td>Cantidad</td>
                      <td><input type="text" maxlength="6" class="form-control" name="cant_servi_prueba" id="cant_servi_prueba" placeholder="Solo Numeros Enteros" pattern="^[1-9]\d*$" required ></td>
                    </tr>
                    @endif
