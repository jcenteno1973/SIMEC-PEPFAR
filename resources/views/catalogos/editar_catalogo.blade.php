...
<div class="panel panel-default">
        ...
        {!! Form::open(['route' => 'catalogos/update_catalogo','class' => 'form']) !!}
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <input type="text" value="{{$obj_catalogo->nombre_catalogo}}" class="form-control" name="nombre" maxlength="35" required>  
                </td> 
              </tr>
            </tbody>
          </table>       
        ...
        <tr>
          <td>
             <button type="submit" class="btn btn-primary">Guardar</button>  
              ...
              @include('ayuda/ayuda_editar_catalogo') 
          </td>
        </tr>        
        </table>
        </div>
