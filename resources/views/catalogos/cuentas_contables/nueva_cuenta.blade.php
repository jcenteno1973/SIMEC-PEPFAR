...
<div class="panel panel-default">
    ...
    {!! Form::open(['route' => 'administracion.contable.store','method'=>'POST']) !!}
    <table class="table table-bordered">    
        <tbody>
           <tr>
               <td>C&oacute;digo de cuenta*</td>
            <td>
                {!! Form::text('cta_contable_activo_fijo', null,['class' => 'form-control' , 'placeholder'=>'C&oacute;digo cuenta contable', 'required' => 'required']) !!}
            </td>
            <td>Nombre Cuenta*</td>
            <td>
                {!! Form::text('cta_contable_depreciacion',null, ['class' => 'form-control' , 'required' => 'required']) !!}
             </td>
            </tr>
            <tr>
                <td>Estado*</td>                 
