            ...
            <div class="modal-dialog"> <!---div class="modal-dialog">-->
                <div class="modal-content"> 
                    ...
                    <div class="modal-header">                    
                        <p class="modal-title">EDITAR DESGLOSE</p>
                    </div>
                        ...
                        <tr>    
                            ...
                            <td>
                                <ul>
                                    ...
                                    <li><strong>Desglose</strong>: Digitar el desglose del catálogo con un maximo de 35 caracteres.</li>
