            ...
            <div class="modal-dialog"> <!---div class="modal-dialog">-->
                <div class="modal-content"> 
                    ...
                    <div class="modal-header">                    
                        <p class="modal-title">EDITAR CATÁLOGO</p>
                    </div>
                        ...
                        <tr>    
                            ...
                            <td>
                                <ul>
                                    ...
                                    <li><strong>Nombre de catálogo</strong>: Digitar el nombre del catálogo con un maximo de 35 caracteres.</li>
