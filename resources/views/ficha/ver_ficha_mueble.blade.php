...
@section('nombre_pantalla')
  <h4 class="text-center">Pantalla ver ficha mueble</h4>    
@stop 
@section('contenido')
<div class="panel panel-default">
    {!! Form::open(['route' => 'ficha/reporte_ficha_mueble', 'class' => 'form']) !!}
            ...
            <tbody>
             ...
             <tr>
              ...
              <tr>
                ...
                <td>Serie</td>
                <td>
                   <input type="text" name="numero_serie" value="{{$obj_ficha->serie_bien}}" class="form-control" readonly="readonly" />                   
                </td> 
                 <td>Color</td>
                <td>                 
