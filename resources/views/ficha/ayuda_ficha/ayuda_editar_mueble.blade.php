<!--
 * Nombre del archivo: ayuda_editar_mueble.blade.php
 * Descripcion: ayuda para la pantalla de editar_ficha_mueble
 * Fecha de creacion: 10/01/17
 * Creado por: Yamileth Campos
 -->
 
 <!--Boton de ayuda-->
    <a href="#editam" class="btn btn- btn-primary" data-toggle="modal">Ayuda</a>
        <div class="modal fade" id="editam" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog"> <!---div class="modal-dialog">-->
                <div class="modal-content"> 
                    <!--header de la ventana-->
                    <div class="modal-header">                    
                        <p class="modal-title">EDITAR FICHA MUEBLE</p>
                    </div>
                    ...
                    <table> 
                        <tr>
                            ...
                            <td>
                                <p> En la pantalla editar ficha mueble, se encuentran los siguientes elementos:</p>
                            </td>
                        </tr>
                        <tr>    
                            <td>
